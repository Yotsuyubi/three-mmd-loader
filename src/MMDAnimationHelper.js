...
import * as MMDPhysics from "./MMDPhysics.js"
import * as CCDIKSolver from "./CCDIKSolver.js"
...
const MMDAnimationHelper = ( function () {
	...
	MMDAnimationHelper.prototype = {
		...
		_createCCDIKSolver: function ( mesh ) {
			...
			if ( CCDIKSolver.default === undefined ) {

				throw new Error( 'THREE.MMDAnimationHelper: Import CCDIKSolver.default.' );

			}

			return new CCDIKSolver.default( mesh, mesh.geometry.userData.MMD.iks );

		},

		_createMMDPhysics: function ( mesh, params ) {

			if ( MMDPhysics.default === undefined ) {

				throw new Error( 'MMDPhysics.default: Import MMDPhysics.default.' );

			}

			return new MMDPhysics.default(
				mesh,
